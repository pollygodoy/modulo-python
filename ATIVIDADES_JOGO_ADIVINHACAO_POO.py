...
#Digite o limite inferior do intervalo de números: 5
#Digite o limite superior do intervalo de números: 10
#Digite o número máximo de tentativas: 1
#Bem-vindo ao jogo de adivinhação de números!
#Vamos personalizar o jogo!

#OK! Estou pensando em um número entre 5 e 10.
#Você tem no máximo 1 tentativas.

#Digite o seu palpite: 15
#Tente um número menor!

#Suas tentativas acabaram! O número correto era 10.
